...
sarki.queue.on('end', () => {
  ...
  .setColor(AloneDogru)
  .setTitle("Wash | Kuyruk Bitti!")
  .setDescription(`<:a_:821738957997211659>  **| Kuyruktaki tüm müzikler oynatıldı. Wash kanaldan ayrılıyor.\n\nWash Tercih ettiğiniz için teşekkür ederiz.**`)
  .setThumbnail(client.user.avatarURL())
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());  
