...
.setColor('#ffffff') 
.setAuthor(`Wash Eklenti Komutları`, client.user.avatarURL())
.setDescription(`<:a_:821738957997211659>  Wash botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
